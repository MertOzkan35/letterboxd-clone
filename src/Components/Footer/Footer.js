  ...
  return (
    <div className="w-full h-[40rem] bg-[#2c3440] flex flex-col">
      <div className="w-full  flex justify-between ">
        <div className="h-[6rem] ml-24  flex  items-center ">
          <a
        ...
        <div className="  h-[6rem] mr-24 flex items-center gap-5  ">
      ...
      <div className="flex justify-start items-start ml-24 pl-4 text-[#4d5b69]">
        <p>
